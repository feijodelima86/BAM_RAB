...
alldata <- read_csv("2_incremental/PCA_INPUT_TEST/20230504completedata_SHOTGUN.csv")
...
BIG5.LABELS<-as.data.frame(na.omit(COMPARTMENTS[,c(c(3,4,5,6,7),c(13,19,22,25,35,40,49)+38)]))
