...
Cu_TD <- glm(Cu ~ F_Cu_NH3, data = Cu_DF, family=gaussian)

no.int_Cu_TD  <- glm(Cu ~ (F_Cu_NH3 + TURNOVER), data = Cu_DF, family=gaussian)

mix.int_Cu_TD <- glm(Cu ~ (F_Cu_NH3 * TURNOVER), data = Cu_DF, family=gaussian)
